...
import { MdFeaturedPlayList, MdLocalOffer, MdNotifications } from 'react-icons/md';
import { GiSlashedShield } from 'react-icons/gi';
import { BsCurrencyDollar, BsInstagram, BsPencil, BsTwitter } from 'react-icons/bs';
        ...
        <div className="row">
            <div className="col-md-3 text-start ps-md-5">
                <div className='bord_rght mt-5'>
                        <h6 className='main_setting_heading'>
                            Setting
                        </h6>
                ...
                <div className='py-4 px-2'>
                    ...
                    <div className="content_setting_right">
                        <div className="row">
                            ...
                            <div className='mt-3'>
                                <label htmlFor="bio" className='label_setting'>Bio</label> <br />
                                {/* <input type="text" id='username' className='seeting_right_input' /> */}
                                <textarea name="" id="bio" cols="30" className='setting_rght_txta setting_hvr'  placeholder='Tell the world your story!' rows="4"></textarea>
                                </div>
                                <div className='mt-3'>
                                <label htmlFor="email" className='label_setting'>Email Address</label> <br />
                                <input type="email" id='email' placeholder='Enter email' className='seeting_right_input setting_hvr' />
                                </div>

                                <div className='mt-3'>
                                    <label htmlFor="#" className='label_setting'>Social Connections</label> <br />
                                    <span className='ss_sub'>Help collectors verify your account by connecting social accounts</span>
                               
                               <div className="d-flex justify-content-between mt-3">
                               <div className="d-flex align-items-center">
                                <BsTwitter className='fs-3 fw-bold me-2'></BsTwitter> <span className='fw-bold'>Twitter</span>
                               </div>
                               ...
                               <div className="d-flex justify-content-between mt-3">
                               <div className="d-flex align-items-center">
                                <BsInstagram className='fs-3 fw-bold me-2'></BsInstagram> <span className='fw-bold'>Instagram</span>
                               </div>
                               ...
                               <div className='mt-3 worrrld'>
                                <label htmlFor="link" className='label_setting'>Links</label> <br />
                                <BiWorld className='world_icon'></BiWorld>
                                <input type="text" id='link' placeholder='yoursite.io' className='seeting_right_input wpl setting_hvr' />
                                </div>
                               ...
                               <div className='mt-3 worrrld'>
                                <label htmlFor="link" className='label_setting'>Wallet Address
</label> <br />
                                <input type="text" id='link' placeholder='0xac4babfa9376bab1cf2b291eceea3c29' className='seeting_right_input setting_hvr ' />
                                <AiOutlineCopy className='world_icon1'></AiOutlineCopy>
                                </div>

                                <div className='mt-3'> <button className='twittwer_connect'>Save</button></div>
