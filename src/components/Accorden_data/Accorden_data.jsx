...
function Accorden_data(props) {
  return (
    <div>
          <div className="row d-flex align-items-center hover_row">
              <div className="col-2">
              ...
              <div className="col-1">
                <svg
                  ...
                  class="sc-9c65691d-0 cuRIUG"
                  fill="none"
                  viewBox="0 0 30 30"
                  className="bg-primary icon_back"
                >
                  <path
