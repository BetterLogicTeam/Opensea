        ...
        <div>
            <div className="sale_main">
                <div width="90%" class="sc-29427738-0 sc-630fc9ab-0 gOUkGc jSPhMX">
                    ...
                    <div data-testid="asset-count" class="sc-29427738-0 sc-bdnxRM kqdVRo fQDfDu">9,998</div>
                </div>
                <Checkbox
                    {...label}
