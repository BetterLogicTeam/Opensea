...
function R_docs_run() {
 ...
 <>
    <div>
        <h3 className='Heading_color_all'><b>Run your own crowd sale</b></h3>
        <p className='prha px-5'>Sell the items in your game to an initial user base of early adopters. <br/> Even sell off items in your own token.</p>
    </div>
    ...
    <div className='container'>
        ...
        <button type="button" class="btn btn-primary btn-lg btn_txt">Create your own crowd sale</button>
